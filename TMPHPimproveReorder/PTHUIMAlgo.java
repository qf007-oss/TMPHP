...
public class PTHUIMAlgo {
    ...
    public void THUIM(String input, String output, int minUtility, Integer[] tarPattern,
        ...
        tagItems = new HashSet<Integer>();
        tagItems.addAll(Arrays.asList(tarPattern));

        /*for (Integer tagItem : tagItems) {
        ...
        try {
            ...
            while ((thisLine = myInput.readLine()) != null) {
                ...
                // ========================= improve ==============================
                // We determine if the transaction contains all the target items
                // notice: the Tid start from 1.
...
//			}
    ...
    private int compareItems(int item1, int item2) {
        // TWU ascend order
        Boolean item1IsTarget = tagItems.contains(item1);
		Boolean item2IsTarget = tagItems.contains(item2);
		if(!item1IsTarget && item2IsTarget) {
			return 1;
		}else if (item1IsTarget && !item2IsTarget)  {
			return -1;
		}
